...
// For /port|rg$dest.
logic [2:0] Port_RG_dest_a1 [5:0],
            Port_RG_dest_a2 [5:0];

// For /port|rg$pass_on.
logic Port_RG_pass_on_a1 [5:0],
      Port_RG_pass_on_a2 [5:0];

// For /port|rg/trans$cyc_cnt.
logic Port_RG_Trans_cyc_cnt_a1 [5:0] /* verilator lint_save */ /* verilator lint_off MULTIDRIVEN */,
      Port_RG_Trans_cyc_cnt_a2 [5:0] /* verilator lint_restore */;

// For /port|rg/trans$data.
logic [7:0] Port_RG_Trans_data_a1 [5:0] /* verilator lint_save */ /* verilator lint_off MULTIDRIVEN */,
            Port_RG_Trans_data_a2 [5:0] /* verilator lint_restore */;

// For /port|rg/trans$sender.
logic [2:0] Port_RG_Trans_sender_a1 [5:0] /* verilator lint_save */ /* verilator lint_off MULTIDRIVEN */,
            Port_RG_Trans_sender_a2 [5:0] /* verilator lint_restore */;

// For /tb/port|passed$passed.
logic [5:0] Tb_Port_PASSED_passed_a1;
...
// Clock signals.
logic clkP_Port_RG_valid_a2 [5:0];
...
// Clock signals.
logic clkP_Port_RING_OUT_trans_valid_a2 [5:0];
...
// Clock signals.
logic clkP_Tb_Port_RECEIVE2_avail_a1 [5:0];
...
generate
   ...
   // Scope: /port[5:0]
   //
   for (port = 0; port <= 5; port++) begin : L1gen_Port
   ...
   //
      ...
      // Scope: /port[5:0]
      //
      for (port = 0; port <= 5; port++) begin : L1gen_Tb_Port
...
generate
   ...
   // Scope: /port[5:0]
   //
   for (port = 0; port <= 5; port++) begin : L1clk_Port
   ...
   //
      ...
      // Scope: /port[5:0]
      //
      for (port = 0; port <= 5; port++) begin : L1clk_Tb_Port
...
generate
   ...
   if (1) begin : DEBUG_SIGS
      ...
      // Scope: /port[5:0]
      //
      for (port = 0; port <= 5; port++) begin : \/port 
