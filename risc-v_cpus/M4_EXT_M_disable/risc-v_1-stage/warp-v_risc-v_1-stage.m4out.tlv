...
\source warp-v_risc-v_1-stage.tlv 7
\SV
   // Include WARP-V.
...
\source warp-v_risc-v_1-stage.tlv 11
\TLV
   \source ./warpv.tlv 3556   // Instantiated from warp-v_risc-v_1-stage.tlv, 13 as: m4+warpv()
      // =================
      //
      //    THE MODEL
      //
      ...
      \source ./warpv.tlv 2814   // Instantiated from warp-v_risc-v_1-stage.tlv, 3564 as: m4+cpu(/top)
         ...
         \source <builtin> 1   // Instantiated from warp-v_risc-v_1-stage.tlv, 2819 as: m4+indirect(M4_IMEM_MACRO_NAME, M4_PROG_NAME)
            \source ./warpv.tlv 1289   // Instantiated from built-in definition.
               \source <builtin> 1   // Instantiated from warp-v_risc-v_1-stage.tlv, 1290 as: m4+indirect(['riscv_']cnt10['_prog'])
               ...
               \source <builtin> 1   // Instantiated from warp-v_risc-v_1-stage.tlv, 3099 as: m4+indirect(M4_isa['_exe'], @M4_EXECUTE_STAGE, @M4_RESULT_STAGE)
                  \source ./warpv.tlv 1641   // Instantiated from built-in definition.
                     ...
                     \source ./warpv.tlv 1394   // Instantiated from warp-v_risc-v_1-stage.tlv, 1894 as: m4+riscv_csrs((m4_csrs))
                        ...
                        \source ./warpv.tlv 1352   // Instantiated from warp-v_risc-v_1-stage.tlv, 13 as: m4+riscv_csr(m4_echo(['m4_csr_']csr['_args']))
                           //--------------
                           // CSR CYCLE
                           //--------------
                           @0
   ...
   \end_source
   \source ./warpv.tlv 3196   // Instantiated from warp-v_risc-v_1-stage.tlv, 14 as: m4+warpv_makerchip_cnt10_tb()
      |fetch
         /instr
            @0
   ...
   \end_source
   \source ./warpv.tlv 4013   // Instantiated from warp-v_risc-v_1-stage.tlv, 15 as: m4+makerchip_pass_fail()
      |done
         @0
            // Assert these to end simulation (before Makerchip cycle limit).
