...
logic [1:0] FETCH_Instr_BranchState_n1,
            FETCH_Instr_BranchState_a0;
logic [1:1] FETCH_Instr_BranchState_a1;
...
logic FETCH_Instr_branch_or_reset_a0,
      FETCH_Instr_branch_or_reset_a1;

// For |fetch/instr$branch_redir_pc.
logic [31:2] FETCH_Instr_branch_redir_pc_a0,
             FETCH_Instr_branch_redir_pc_a1,
             FETCH_Instr_branch_redir_pc_a2;

// For |fetch/instr$branch_target.
logic [31:2] FETCH_Instr_branch_target_a0,
             FETCH_Instr_branch_target_a1;
...
logic [31:2] FETCH_Instr_indirect_jump_target_a0,
             FETCH_Instr_indirect_jump_target_a1,
             FETCH_Instr_indirect_jump_target_a2;
...
logic FETCH_Instr_mispred_branch_a0,
      FETCH_Instr_mispred_branch_a1,
      FETCH_Instr_mispred_branch_a2;
...
logic FETCH_Instr_non_aborting_trap_a0,
      ...
      FETCH_Instr_non_aborting_trap_a2,
...
logic FETCH_Instr_pred_taken_branch_a0,
      FETCH_Instr_pred_taken_branch_a1;
...
logic FETCH_Instr_replay_int_a0;
...
logic FETCH_Instr_stall_cnt_upper_div_a0,
      ...
      FETCH_Instr_stall_cnt_upper_div_a2,
      FETCH_Instr_stall_cnt_upper_div_a3;

// For |fetch/instr$stall_cnt_upper_mul.
logic FETCH_Instr_stall_cnt_upper_mul_a0,
      FETCH_Instr_stall_cnt_upper_mul_a1,
      FETCH_Instr_stall_cnt_upper_mul_a2,
      FETCH_Instr_stall_cnt_upper_mul_a3;
...
logic FETCH_Instr_trigger_next_pc_div_mul_second_issue_a0,
      ...
      FETCH_Instr_trigger_next_pc_div_mul_second_issue_a2,
      FETCH_Instr_trigger_next_pc_div_mul_second_issue_a3;
...
logic FETCH_Instr_valid_decode_branch_a0,
      FETCH_Instr_valid_decode_branch_a1;
...
logic [4:0] FETCH_Instr_HoldInst_dest_reg_a0,
            ...
            FETCH_Instr_HoldInst_dest_reg_a2,
            FETCH_Instr_HoldInst_dest_reg_a3;
...
logic FETCH_Instr_Regs_pending_n1 [31:1],
      ...
      FETCH_Instr_Regs_pending_a1 [31:1],
      FETCH_Instr_Regs_pending_a2 [31:1];

// For |fetch/instr/regs$value.
logic [31:0] FETCH_Instr_Regs_value_a0 [31:1],
             FETCH_Instr_Regs_value_a1 [31:1],
             FETCH_Instr_Regs_value_a2 [31:1];
...
logic MEM_Data_valid_ld_a0,
      ...
      MEM_Data_valid_ld_a2,
      MEM_Data_valid_ld_a3,
...
// Clock signals.
logic clkF_FETCH_Instr_branch_or_reset_a1 ;
logic clkF_FETCH_Instr_branch_or_reset_a2 ;
logic clkP_FETCH_Instr_indirect_jump_a1 ;
logic clkP_FETCH_Instr_indirect_jump_a2 ;
logic clkP_FETCH_Instr_jump_a1 ;
logic clkP_FETCH_Instr_jump_a2 ;
logic clkP_FETCH_Instr_valid_decode_branch_a1 ;
...
generate
   ...
   //
      ...
      //
         ...
         // For $BranchState.
         always_ff @(posedge clkF_FETCH_Instr_branch_or_reset_a1) FETCH_Instr_BranchState_a0[1:0] <= FETCH_Instr_BranchState_n1[1:0];
         always_ff @(posedge clkF_FETCH_Instr_branch_or_reset_a2) FETCH_Instr_BranchState_a1[1] <= FETCH_Instr_BranchState_a0[1];
         ...
         always_ff @(posedge clk) FETCH_Instr_aborting_trap_a2 <= FETCH_Instr_aborting_trap_a1;
         always_ff @(posedge clk) FETCH_Instr_aborting_trap_a3 <= FETCH_Instr_aborting_trap_a2;

         // For $branch_or_reset.
         always_ff @(posedge clk) FETCH_Instr_branch_or_reset_a1 <= FETCH_Instr_branch_or_reset_a0;

         // For $branch_redir_pc.
         always_ff @(posedge clkP_FETCH_Instr_valid_decode_branch_a1) FETCH_Instr_branch_redir_pc_a1[31:2] <= FETCH_Instr_branch_redir_pc_a0[31:2];
         always_ff @(posedge clkP_FETCH_Instr_valid_decode_branch_a2) FETCH_Instr_branch_redir_pc_a2[31:2] <= FETCH_Instr_branch_redir_pc_a1[31:2];

         // For $branch_target.
         always_ff @(posedge clkP_FETCH_Instr_valid_decode_branch_a1) FETCH_Instr_branch_target_a1[31:2] <= FETCH_Instr_branch_target_a0[31:2];
         ...
         // For $dest_reg_valid.
         always_ff @(posedge clk) FETCH_Instr_dest_reg_valid_a1 <= FETCH_Instr_dest_reg_valid_a0;
         ...
         // For $indirect_jump.
         always_ff @(posedge clk) FETCH_Instr_indirect_jump_a1 <= FETCH_Instr_indirect_jump_a0;
         always_ff @(posedge clk) FETCH_Instr_indirect_jump_a2 <= FETCH_Instr_indirect_jump_a1;

         // For $indirect_jump_target.
         always_ff @(posedge clkP_FETCH_Instr_indirect_jump_a1) FETCH_Instr_indirect_jump_target_a1[31:2] <= FETCH_Instr_indirect_jump_target_a0[31:2];
         always_ff @(posedge clkP_FETCH_Instr_indirect_jump_a2) FETCH_Instr_indirect_jump_target_a2[31:2] <= FETCH_Instr_indirect_jump_target_a1[31:2];
         ...
         // For $jump.
         always_ff @(posedge clk) FETCH_Instr_jump_a1 <= FETCH_Instr_jump_a0;
         always_ff @(posedge clk) FETCH_Instr_jump_a2 <= FETCH_Instr_jump_a1;

         // For $jump_target.
         always_ff @(posedge clkP_FETCH_Instr_jump_a1) FETCH_Instr_jump_target_a1[31:2] <= FETCH_Instr_jump_target_a0[31:2];
         always_ff @(posedge clkP_FETCH_Instr_jump_a2) FETCH_Instr_jump_target_a2[31:2] <= FETCH_Instr_jump_target_a1[31:2];

         // For $mispred_branch.
         always_ff @(posedge clk) FETCH_Instr_mispred_branch_a1 <= FETCH_Instr_mispred_branch_a0;
         always_ff @(posedge clk) FETCH_Instr_mispred_branch_a2 <= FETCH_Instr_mispred_branch_a1;
         ...
         always_ff @(posedge clk) FETCH_Instr_non_aborting_trap_a2 <= FETCH_Instr_non_aborting_trap_a1;
         ...
         always_ff @(posedge clk) FETCH_Instr_non_pipelined_a2 <= FETCH_Instr_non_pipelined_a1;
         always_ff @(posedge clk) FETCH_Instr_non_pipelined_a3 <= FETCH_Instr_non_pipelined_a2;

         // For $pred_taken_branch.
         always_ff @(posedge clk) FETCH_Instr_pred_taken_branch_a1 <= FETCH_Instr_pred_taken_branch_a0;

         // For $reg_wr_pending.
         always_ff @(posedge clk) FETCH_Instr_reg_wr_pending_a1 <= FETCH_Instr_reg_wr_pending_a0;
         ...
         // For $rslt.
         always_ff @(posedge clk) FETCH_Instr_rslt_a1[31:0] <= FETCH_Instr_rslt_a0[31:0];
         always_ff @(posedge clk) FETCH_Instr_rslt_a2[31:0] <= FETCH_Instr_rslt_a1[31:0];
         ...
         // For $stall_cnt_upper_div.
         always_ff @(posedge clk) FETCH_Instr_stall_cnt_upper_div_a1 <= FETCH_Instr_stall_cnt_upper_div_a0;
         always_ff @(posedge clk) FETCH_Instr_stall_cnt_upper_div_a2 <= FETCH_Instr_stall_cnt_upper_div_a1;
         always_ff @(posedge clk) FETCH_Instr_stall_cnt_upper_div_a3 <= FETCH_Instr_stall_cnt_upper_div_a2;

         // For $stall_cnt_upper_mul.
         always_ff @(posedge clk) FETCH_Instr_stall_cnt_upper_mul_a1 <= FETCH_Instr_stall_cnt_upper_mul_a0;
         always_ff @(posedge clk) FETCH_Instr_stall_cnt_upper_mul_a2 <= FETCH_Instr_stall_cnt_upper_mul_a1;
         always_ff @(posedge clk) FETCH_Instr_stall_cnt_upper_mul_a3 <= FETCH_Instr_stall_cnt_upper_mul_a2;

         // For $trap_target.
         always_ff @(posedge clk) FETCH_Instr_trap_target_a1[31:2] <= FETCH_Instr_trap_target_a0[31:2];
         always_ff @(posedge clk) FETCH_Instr_trap_target_a2[31:2] <= FETCH_Instr_trap_target_a1[31:2];
         ...
         always_ff @(posedge clk) FETCH_Instr_trigger_next_pc_div_mul_second_issue_a2 <= FETCH_Instr_trigger_next_pc_div_mul_second_issue_a1;
         always_ff @(posedge clk) FETCH_Instr_trigger_next_pc_div_mul_second_issue_a3 <= FETCH_Instr_trigger_next_pc_div_mul_second_issue_a2;

         // For $valid_decode_branch.
         always_ff @(posedge clk) FETCH_Instr_valid_decode_branch_a1 <= FETCH_Instr_valid_decode_branch_a0;
         ...
         //
            ...
            always_ff @(posedge clk) FETCH_Instr_HoldInst_dest_reg_a2[4:0] <= FETCH_Instr_HoldInst_dest_reg_a1[4:0];
            always_ff @(posedge clk) FETCH_Instr_HoldInst_dest_reg_a3[4:0] <= FETCH_Instr_HoldInst_dest_reg_a2[4:0];
            ...
            for (src = 1; src <= 2; src++) begin : L1gen_FETCH_Instr_HoldInst_Src
               ...
               always_ff @(posedge clk) L1_FETCH_Instr_HoldInst_Src[src].L1_dummy_a2 <= L1_FETCH_Instr_HoldInst_Src[src].L1_dummy_a1;
               always_ff @(posedge clk) L1_FETCH_Instr_HoldInst_Src[src].L1_dummy_a3 <= L1_FETCH_Instr_HoldInst_Src[src].L1_dummy_a2;
         ...
         for (regs = 1; regs <= 31; regs++) begin : L1gen_FETCH_Instr_Regs
            ...
            always_ff @(posedge clk) FETCH_Instr_Regs_pending_a1[regs] <= FETCH_Instr_Regs_pending_a0[regs];
            always_ff @(posedge clk) FETCH_Instr_Regs_pending_a2[regs] <= FETCH_Instr_Regs_pending_a1[regs];

            // For $value.
            always_ff @(posedge clk) FETCH_Instr_Regs_value_a1[regs][31:0] <= FETCH_Instr_Regs_value_a0[regs][31:0];
            always_ff @(posedge clk) FETCH_Instr_Regs_value_a2[regs][31:0] <= FETCH_Instr_Regs_value_a1[regs][31:0];
   ...
   //
      ...
      //
         ...
         always_ff @(posedge clk) MEM_Data_addr_a2[1:0] <= MEM_Data_addr_a1[1:0];
         always_ff @(posedge clk) MEM_Data_addr_a3[1:0] <= MEM_Data_addr_a2[1:0];
         ...
         always_ff @(posedge clk) MEM_Data_dest_reg_a2[4:0] <= MEM_Data_dest_reg_a1[4:0];
         always_ff @(posedge clk) MEM_Data_dest_reg_a3[4:0] <= MEM_Data_dest_reg_a2[4:0];
         ...
         always_ff @(posedge clk) MEM_Data_ld_st_half_a2 <= MEM_Data_ld_st_half_a1;
         always_ff @(posedge clk) MEM_Data_ld_st_half_a3 <= MEM_Data_ld_st_half_a2;
         ...
         always_ff @(posedge clk) MEM_Data_ld_st_word_a2 <= MEM_Data_ld_st_word_a1;
         always_ff @(posedge clk) MEM_Data_ld_st_word_a3 <= MEM_Data_ld_st_word_a2;
         ...
         always_ff @(posedge clk) MEM_Data_ld_value_a2[31:0] <= MEM_Data_ld_value_a1[31:0];
         always_ff @(posedge clk) MEM_Data_ld_value_a3[31:0] <= MEM_Data_ld_value_a2[31:0];
         ...
         always_ff @(posedge clk) MEM_Data_raw_funct3_a2[2] <= MEM_Data_raw_funct3_a1[2];
         always_ff @(posedge clk) MEM_Data_raw_funct3_a3[2] <= MEM_Data_raw_funct3_a2[2];
         ...
         always_ff @(posedge clk) MEM_Data_spec_ld_a2 <= MEM_Data_spec_ld_a1;
         always_ff @(posedge clk) MEM_Data_spec_ld_a3 <= MEM_Data_spec_ld_a2;
         ...
         always_ff @(posedge clk) MEM_Data_valid_ld_a2 <= MEM_Data_valid_ld_a1;
         always_ff @(posedge clk) MEM_Data_valid_ld_a3 <= MEM_Data_valid_ld_a2;
         ...
         for (src = 1; src <= 2; src++) begin : L1gen_MEM_Data_Src
            ...
            always_ff @(posedge clk) L1_MEM_Data_Src[src].L1_dummy_a2 <= L1_MEM_Data_Src[src].L1_dummy_a1;
            always_ff @(posedge clk) L1_MEM_Data_Src[src].L1_dummy_a3 <= L1_MEM_Data_Src[src].L1_dummy_a2;
...
generate
   ...
   //
      ...
      //
         ...
         clk_gate gen_clkF_FETCH_Instr_branch_or_reset_a1(clkF_FETCH_Instr_branch_or_reset_a1, clk, FETCH_Instr_branch_or_reset_a0, 1'b1, 1'b0);
         clk_gate gen_clkF_FETCH_Instr_branch_or_reset_a2(clkF_FETCH_Instr_branch_or_reset_a2, clk, FETCH_Instr_branch_or_reset_a1, 1'b1, 1'b0);
         clk_gate gen_clkP_FETCH_Instr_indirect_jump_a1(clkP_FETCH_Instr_indirect_jump_a1, clk, 1'b1, FETCH_Instr_indirect_jump_a0, 1'b0);
         clk_gate gen_clkP_FETCH_Instr_indirect_jump_a2(clkP_FETCH_Instr_indirect_jump_a2, clk, 1'b1, FETCH_Instr_indirect_jump_a1, 1'b0);
         clk_gate gen_clkP_FETCH_Instr_jump_a1(clkP_FETCH_Instr_jump_a1, clk, 1'b1, FETCH_Instr_jump_a0, 1'b0);
