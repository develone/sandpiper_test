...
`include "warp-v_risc-v_4-stage_gen.sv" //_\TLV
   //_\source ./warpv.tlv 3556   // Instantiated from warp-v_risc-v_4-stage.tlv, 11 as: m4+warpv()
      ...
      //_\source ./warpv.tlv 2814   // Instantiated from warp-v_risc-v_4-stage.tlv, 3564 as: m4+cpu(/top)
         // Generated logic
         //_\source <builtin> 1   // Instantiated from warp-v_risc-v_4-stage.tlv, 2816 as: m4+indirect(M4_isa['_gen'])
         ...
         //_\source <builtin> 1   // Instantiated from warp-v_risc-v_4-stage.tlv, 2819 as: m4+indirect(M4_IMEM_MACRO_NAME, M4_PROG_NAME)
            //_\source ./warpv.tlv 1289   // Instantiated from built-in definition.
               //_\source <builtin> 1   // Instantiated from warp-v_risc-v_4-stage.tlv, 1290 as: m4+indirect(['riscv_']divmul_test['_prog'])
                  ...
                  //_\end_source
               //_\end_source
               //_\source ./warpv.tlv 3641   // Instantiated from warp-v_risc-v_4-stage.tlv, 1291 as: m4+instrs_for_viz()
         ...
         //_|fetch
            //_/instr
               ...
               //_@1
                  ...
                  //_\source <builtin> 1   // Instantiated from warp-v_risc-v_4-stage.tlv, 3013 as: m4+indirect(M4_isa['_decode'])
                     //_\source ./warpv.tlv 1498   // Instantiated from built-in definition.
                        ...
                        //_?$valid_decode
                           ...
                           // Instruction decode.
                           //_\source ./warpv.tlv 1478   // Instantiated from warp-v_risc-v_4-stage.tlv, 1526 as: m4+riscv_decode_expr()
                        ...
                        //_?$valid_decode
                           ...
                           for (src = 1; src <= 2; src++) begin : L1_FETCH_Instr_Src logic L1_is_reg_a1; logic [4:0] L1_reg_a1; //_/src
                              ...
                              assign L1_is_reg_a1 = FETCH_Instr_is_r_type_a1 || FETCH_Instr_is_r4_type_a1 || (FETCH_Instr_is_i_type_a1 && (src == 1)) || FETCH_Instr_is_r2_type_a1 || FETCH_Instr_is_s_type_a1 || FETCH_Instr_is_b_type_a1;
                        ...
                        assign FETCH_Instr_dest_reg_a1[4:0] = FETCH_Instr_second_issue_div_mul_a1 ? FETCH_Instr_HoldInst_dest_reg_a4 :
                                                         FETCH_Instr_second_issue_ld_a1 ? FETCH_Instr_OrigInst_dest_reg_a1 : FETCH_Instr_raw_rd_a1;
                     ...
                     //_\end_source
                  //_\end_source
               //_\source <builtin> 1   // Instantiated from warp-v_risc-v_4-stage.tlv, 3014 as: m4+indirect(['branch_pred_']M4_BRANCH_PRED)
               ...
               // Execute
               // =======
               //_\source <builtin> 1   // Instantiated from warp-v_risc-v_4-stage.tlv, 3099 as: m4+indirect(M4_isa['_exe'], @M4_EXECUTE_STAGE, @M4_RESULT_STAGE)
                  //_\source ./warpv.tlv 1641   // Instantiated from built-in definition.
                     ...
                     // CSR logic
                     // ---------
                     //_\source ./warpv.tlv 1394   // Instantiated from warp-v_risc-v_4-stage.tlv, 1894 as: m4+riscv_csrs((m4_csrs))
                     ...
                     //_\end_source
                     //_@2
                        //_\source ./warpv.tlv 1399   // Instantiated from warp-v_risc-v_4-stage.tlv, 1896 as: m4+riscv_csr_logic()
                     ...
                     //_@2
                        ...
                        //_\source ./warpv.tlv 1481   // Instantiated from warp-v_risc-v_4-stage.tlv, 1955 as: m4+riscv_rslt_mux_expr()
         ...
         //_\source ./warpv.tlv 2464   // Instantiated from warp-v_risc-v_4-stage.tlv, 3158 as: m4+fixed_latency_fake_memory(/top, 0)
            ...
            //_|mem
               //_/data
                  //_@3
                     assign {MEM_Data_addr_a3[1:0], MEM_Data_dest_reg_a3[4:0], MEM_Data_ld_st_half_a3, MEM_Data_ld_st_word_a3, MEM_Data_ld_value_a3[31:0], MEM_Data_raw_funct3_a3[2], MEM_Data_spec_ld_a3, MEM_Data_valid_ld_a3} = {FETCH_Instr_addr_a3[1:0], FETCH_Instr_dest_reg_a3, FETCH_Instr_ld_st_half_a3, FETCH_Instr_ld_st_word_a3, FETCH_Instr_ld_value_a3, FETCH_Instr_raw_funct3_a3[2], FETCH_Instr_spec_ld_a3, FETCH_Instr_valid_ld_a3};
