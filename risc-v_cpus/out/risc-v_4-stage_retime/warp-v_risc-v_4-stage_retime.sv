...
`include "sp_default.vh" //_\source warp-v_risc-v_4-stage_retime.tlv 7
//_\SV
   // Include WARP-V.
...
//_\source warp-v_risc-v_4-stage_retime.tlv 11
`include "warp-v_risc-v_4-stage_retime_gen.sv" //_\TLV
   //_\source ./warpv.tlv 3556   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 13 as: m4+warpv()
      // =================
      //
      //    THE MODEL
      //
      ...
      //_\source ./warpv.tlv 2814   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 3564 as: m4+cpu(/top)
         // Generated logic
         //_\source <builtin> 1   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 2816 as: m4+indirect(M4_isa['_gen'])
         ...
         //_\source <builtin> 1   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 2819 as: m4+indirect(M4_IMEM_MACRO_NAME, M4_PROG_NAME)
            //_\source ./warpv.tlv 1289   // Instantiated from built-in definition.
               //_\source <builtin> 1   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 1290 as: m4+indirect(['riscv_']divmul_test['_prog'])
                  ...
                  //_\end_source
               //_\end_source
               //_\source ./warpv.tlv 3641   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 1291 as: m4+instrs_for_viz()
         ...
         //_|fetch
            //_/instr
               ...
               //_@0
                  ...
                  //_\source <builtin> 1   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 3013 as: m4+indirect(M4_isa['_decode'])
                     //_\source ./warpv.tlv 1498   // Instantiated from built-in definition.
                        ...
                        //_?$valid_decode
                           ...
                           // Instruction decode.
                           //_\source ./warpv.tlv 1478   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 1526 as: m4+riscv_decode_expr()
                        ...
                        assign FETCH_Instr_dest_reg_a0[4:0] = FETCH_Instr_second_issue_div_mul_a0 ? FETCH_Instr_HoldInst_dest_reg_a3 :
                     ...
                     //_\end_source
                  //_\end_source
               //_\source <builtin> 1   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 3014 as: m4+indirect(['branch_pred_']M4_BRANCH_PRED)
                  //_\source ./warpv.tlv 2532   // Instantiated from built-in definition.
                     ...
                     //_@0
                        ...
                        //_?$branch_or_reset
                           assign FETCH_Instr_BranchState_n1[1:0] =
               ...
               //_@0
                  ...
                  for (src = 1; src <= 2; src++) begin : L1b_FETCH_Instr_Src logic L1_dummy_a0; logic L1_is_reg_condition_a0; logic L1_pending_a0; logic [31:0] L1_reg_value_a0; //_/src
                     ...
                     //_?$is_reg_condition
                        assign {L1_reg_value_a0[31:0], L1_pending_a0} =
                           ...
                           (FETCH_Instr_dest_reg_valid_a1 && (FETCH_Instr_GoodPathMask_a0[1] || FETCH_Instr_second_issue_a1) && (FETCH_Instr_dest_reg_a1 == L1_FETCH_Instr_Src[src].L1_reg_a0)) ? {FETCH_Instr_rslt_a1, FETCH_Instr_reg_wr_pending_a1} :
                           (FETCH_Instr_dest_reg_valid_a2 && (FETCH_Instr_GoodPathMask_a0[2] || FETCH_Instr_second_issue_a2) && (FETCH_Instr_dest_reg_a2 == L1_FETCH_Instr_Src[src].L1_reg_a0)) ? {FETCH_Instr_rslt_a2, FETCH_Instr_reg_wr_pending_a2} :
                           
                           {FETCH_Instr_Regs_value_a2[L1_FETCH_Instr_Src[src].L1_reg_a0], FETCH_Instr_Regs_pending_a2[L1_FETCH_Instr_Src[src].L1_reg_a0]};
                  ...
                  //_?$is_dest_condition
                     assign FETCH_Instr_dest_pending_a0 =
                        ...
                        // Bypass stages. Both register and pending are bypassed.
                        (FETCH_Instr_dest_reg_valid_a1 && (FETCH_Instr_GoodPathMask_a0[1] || FETCH_Instr_second_issue_a1) && (FETCH_Instr_dest_reg_a1 == FETCH_Instr_dest_reg_a0)) ? FETCH_Instr_reg_wr_pending_a1 :
                        (FETCH_Instr_dest_reg_valid_a2 && (FETCH_Instr_GoodPathMask_a0[2] || FETCH_Instr_second_issue_a2) && (FETCH_Instr_dest_reg_a2 == FETCH_Instr_dest_reg_a0)) ? FETCH_Instr_reg_wr_pending_a2 :
                        
                        FETCH_Instr_Regs_pending_a2[FETCH_Instr_dest_reg_a0];
               ...
               // Execute
               // =======
               //_\source <builtin> 1   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 3099 as: m4+indirect(M4_isa['_exe'], @M4_EXECUTE_STAGE, @M4_RESULT_STAGE)
                  //_\source ./warpv.tlv 1641   // Instantiated from built-in definition.
                     // if M_EXT is enabled, this handles the stalling logic
                     
                     //_\source ./warpv.tlv 2570   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 13 as: m4+m_extension()
                     ...
                     //_@0
                        ...
                        //_\source ./warpv.tlv 2607   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 13 as: m4+warpv_mul(|fetch/instr,/mul1, $mulblock_rslt, $wrm, $waitm, $readym, $clk, $resetn, $mul_in1, $mul_in2, $instr_type_mul, $mulblk_valid)
                           //_/mul1      
                        ...
                        //_\end_source
                        //_\source ./warpv.tlv 2637   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 13 as: m4+warpv_div(|fetch/instr,/div1, $divblock_rslt, $wrd, $waitd, $readyd, $clk, $resetn, $div_in1, $div_in2, $instr_type_div, >>1$div_stall)
                           //_/div1
                        ...
                        //_/hold_inst
                           assign {FETCH_Instr_HoldInst_dest_reg_a0[4:0]} = 1'b0  || (FETCH_Instr_mulblk_valid_a0 || (FETCH_Instr_div_stall_a0 && FETCH_Instr_commit_a0))  ? {FETCH_Instr_dest_reg_a0} : {FETCH_Instr_HoldInst_dest_reg_a1};
                           for (src = 1; src <= 2; src++) begin : L1_FETCH_Instr_HoldInst_Src logic L1_dummy_a0, L1_dummy_a1, L1_dummy_a2, L1_dummy_a3; //_/src
                              assign {L1_dummy_a0} = 1'b0  || (FETCH_Instr_mulblk_valid_a0 || (FETCH_Instr_div_stall_a0 && FETCH_Instr_commit_a0))  ? {L1b_FETCH_Instr_Src[src].L1_dummy_a0} : {L1_dummy_a1}; end
                     ...
                     // CSR logic
                     // ---------
                     //_\source ./warpv.tlv 1394   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 1894 as: m4+riscv_csrs((m4_csrs))
                        
                        //_\source ./warpv.tlv 1352   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 13 as: m4+riscv_csr(m4_echo(['m4_csr_']csr['_args']))
                           //--------------
                           // CSR CYCLE
                           //--------------
                           //_@0
                     ...
                     //_\end_source
                     //_@0
                        //_\source ./warpv.tlv 1399   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 1896 as: m4+riscv_csr_logic()
                     ...
                     //_@0
                        ...
                        //_\source ./warpv.tlv 1481   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 1955 as: m4+riscv_rslt_mux_expr()
                           ...
                           assign FETCH_Instr_rslt_a0[31:0] =
                                 ...
                                 (FETCH_Instr_second_issue_div_mul_a0 && FETCH_Instr_stall_cnt_upper_div_a3) ? FETCH_Instr_divblock_rslt_a0 : 
                                 (FETCH_Instr_second_issue_div_mul_a0 && FETCH_Instr_stall_cnt_upper_mul_a3) ? FETCH_Instr_mulblock_rslt_a0 :
               ...
               //_@0
                  ...
                  //_?$valid_decode_branch
                     assign FETCH_Instr_branch_redir_pc_a0[31:2] =
                        ...
                        (! FETCH_Instr_taken_a0) ? FETCH_Instr_Pc_a0 + 30'b1 :
                  ...
                  assign FETCH_Instr_commit_a0 = 1'b1 && ! FETCH_Instr_abort_a0;
         ...
         //_\source ./warpv.tlv 2464   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 3158 as: m4+fixed_latency_fake_memory(/top, 0)
            ...
            //_|mem
               //_/data
                  //_@0
                     ...
                     for (src = 1; src <= 2; src++) begin : L1_MEM_Data_Src logic L1_dummy_a0, L1_dummy_a1, L1_dummy_a2, L1_dummy_a3, L1_dummy_a4; //_/src
   ...
   //_\end_source
   //_\source ./warpv.tlv 3196   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 14 as: m4+warpv_makerchip_cnt10_tb()
      //_|fetch
         //_/instr
            //_@0
   ...
   //_\end_source
   //_\source ./warpv.tlv 4013   // Instantiated from warp-v_risc-v_4-stage_retime.tlv, 15 as: m4+makerchip_pass_fail()
      //_|done
         //_@0
            // Assert these to end simulation (before Makerchip cycle limit).
