...
logic [31:0] FETCH_Instr_div_in1_a2,
             FETCH_Instr_div_in1_a3;

// For |fetch/instr$div_in2.
logic [31:0] FETCH_Instr_div_in2_a2,
             FETCH_Instr_div_in2_a3;
...
logic [31:0] FETCH_Instr_div_rslt_a2;

// For |fetch/instr$div_stall.
logic FETCH_Instr_div_stall_a2,
      FETCH_Instr_div_stall_a3;

// For |fetch/instr$divblk_valid.
logic FETCH_Instr_divblk_valid_a2;

// For |fetch/instr$divblock_rslt.
logic [31:0] FETCH_Instr_divblock_rslt_a2;

// For |fetch/instr$divtype_instr.
logic FETCH_Instr_divtype_instr_a1,
      FETCH_Instr_divtype_instr_a2;

// For |fetch/instr$divu_rslt.
logic [31:0] FETCH_Instr_divu_rslt_a2;
...
logic [3:0] FETCH_Instr_instr_type_div_a2,
            FETCH_Instr_instr_type_div_a3;

// For |fetch/instr$instr_type_mul.
logic [3:0] FETCH_Instr_instr_type_mul_a2,
            FETCH_Instr_instr_type_mul_a3;
...
logic FETCH_Instr_is_div_instr_a1,
      FETCH_Instr_is_div_instr_a2;

// For |fetch/instr$is_divu_instr.
logic FETCH_Instr_is_divu_instr_a1,
      FETCH_Instr_is_divu_instr_a2;
...
logic FETCH_Instr_is_mul_instr_a1,
      FETCH_Instr_is_mul_instr_a2;

// For |fetch/instr$is_mulh_instr.
logic FETCH_Instr_is_mulh_instr_a1,
      FETCH_Instr_is_mulh_instr_a2;

// For |fetch/instr$is_mulhsu_instr.
logic FETCH_Instr_is_mulhsu_instr_a1,
      FETCH_Instr_is_mulhsu_instr_a2;

// For |fetch/instr$is_mulhu_instr.
logic FETCH_Instr_is_mulhu_instr_a1,
      FETCH_Instr_is_mulhu_instr_a2;
...
logic FETCH_Instr_is_rem_instr_a1,
      FETCH_Instr_is_rem_instr_a2;

// For |fetch/instr$is_remu_instr.
logic FETCH_Instr_is_remu_instr_a1,
      FETCH_Instr_is_remu_instr_a2;
...
logic [31:0] FETCH_Instr_mul_in1_a2,
             FETCH_Instr_mul_in1_a3;

// For |fetch/instr$mul_in2.
logic [31:0] FETCH_Instr_mul_in2_a2,
             FETCH_Instr_mul_in2_a3;

// For |fetch/instr$mul_rslt.
logic [31:0] FETCH_Instr_mul_rslt_a2;

// For |fetch/instr$mul_stall.
logic FETCH_Instr_mul_stall_a2,
      FETCH_Instr_mul_stall_a3;

// For |fetch/instr$mulblk_valid.
logic FETCH_Instr_mulblk_valid_a2;

// For |fetch/instr$mulblock_rslt.
logic [31:0] FETCH_Instr_mulblock_rslt_a2;

// For |fetch/instr$mulh_rslt.
logic [31:0] FETCH_Instr_mulh_rslt_a2;

// For |fetch/instr$mulhsu_rslt.
logic [31:0] FETCH_Instr_mulhsu_rslt_a2;

// For |fetch/instr$mulhu_rslt.
logic [31:0] FETCH_Instr_mulhu_rslt_a2;
...
logic FETCH_Instr_readyd_a2;

// For |fetch/instr$readym.
logic FETCH_Instr_readym_a2;
...
logic [31:0] FETCH_Instr_rem_rslt_a2;

// For |fetch/instr$remu_rslt.
logic [31:0] FETCH_Instr_remu_rslt_a2;
...
logic FETCH_Instr_second_issue_div_mul_a0,
      FETCH_Instr_second_issue_div_mul_a1,
      FETCH_Instr_second_issue_div_mul_a2;
...
logic [5:0] FETCH_Instr_stall_cnt_a2,
            FETCH_Instr_stall_cnt_a3;

// For |fetch/instr$stall_cnt_upper_div.
logic FETCH_Instr_stall_cnt_upper_div_a2,
      FETCH_Instr_stall_cnt_upper_div_a3,
      FETCH_Instr_stall_cnt_upper_div_a4,
      FETCH_Instr_stall_cnt_upper_div_a5;

// For |fetch/instr$stall_cnt_upper_mul.
logic FETCH_Instr_stall_cnt_upper_mul_a2,
      FETCH_Instr_stall_cnt_upper_mul_a3,
      FETCH_Instr_stall_cnt_upper_mul_a4,
      FETCH_Instr_stall_cnt_upper_mul_a5;
...
logic FETCH_Instr_trigger_next_pc_div_mul_second_issue_a2,
...
logic FETCH_Instr_waitd_a2;

// For |fetch/instr$waitm.
logic FETCH_Instr_waitm_a2;

// For |fetch/instr$wrd.
logic FETCH_Instr_wrd_a2;

// For |fetch/instr$wrm.
logic FETCH_Instr_wrm_a2;
...
logic [31:0] FETCH_Instr_Div1_div_insn_a2;

// For |fetch/instr/div1$opcode.
logic [2:0] FETCH_Instr_Div1_opcode_a2;

// For |fetch/instr/hold_inst$dest_reg.
logic [4:0] FETCH_Instr_HoldInst_dest_reg_a2,
            FETCH_Instr_HoldInst_dest_reg_a3,
            FETCH_Instr_HoldInst_dest_reg_a4;

// For |fetch/instr/mul1$mul_insn.
logic [31:0] FETCH_Instr_Mul1_mul_insn_a2;

// For |fetch/instr/mul1$opcode.
logic [2:0] FETCH_Instr_Mul1_opcode_a2;
...
generate
   ...
   //
      ...
      //
         ...
         // For $div_in1.
         always_ff @(posedge clkP_FETCH_Instr_valid_exe_a3) FETCH_Instr_div_in1_a3[31:0] <= FETCH_Instr_div_in1_a2[31:0];

         // For $div_in2.
         always_ff @(posedge clkP_FETCH_Instr_valid_exe_a3) FETCH_Instr_div_in2_a3[31:0] <= FETCH_Instr_div_in2_a2[31:0];

         // For $div_mul.
         always_ff @(posedge clkP_FETCH_Instr_valid_decode_a2) FETCH_Instr_div_mul_a2 <= FETCH_Instr_div_mul_a1;

         // For $div_stall.
         always_ff @(posedge clk) FETCH_Instr_div_stall_a3 <= FETCH_Instr_div_stall_a2;

         // For $divtype_instr.
         always_ff @(posedge clkP_FETCH_Instr_valid_decode_a2) FETCH_Instr_divtype_instr_a2 <= FETCH_Instr_divtype_instr_a1;
         ...
         // For $instr_type_div.
         always_ff @(posedge clkP_FETCH_Instr_valid_exe_a3) FETCH_Instr_instr_type_div_a3[3:0] <= FETCH_Instr_instr_type_div_a2[3:0];

         // For $instr_type_mul.
         always_ff @(posedge clkP_FETCH_Instr_valid_exe_a3) FETCH_Instr_instr_type_mul_a3[3:0] <= FETCH_Instr_instr_type_mul_a2[3:0];
         ...
         // For $is_div_instr.
         always_ff @(posedge clkP_FETCH_Instr_valid_decode_a2) FETCH_Instr_is_div_instr_a2 <= FETCH_Instr_is_div_instr_a1;

         // For $is_divu_instr.
         always_ff @(posedge clkP_FETCH_Instr_valid_decode_a2) FETCH_Instr_is_divu_instr_a2 <= FETCH_Instr_is_divu_instr_a1;
         ...
         // For $is_mul_instr.
         always_ff @(posedge clkP_FETCH_Instr_valid_decode_a2) FETCH_Instr_is_mul_instr_a2 <= FETCH_Instr_is_mul_instr_a1;

         // For $is_mulh_instr.
         always_ff @(posedge clkP_FETCH_Instr_valid_decode_a2) FETCH_Instr_is_mulh_instr_a2 <= FETCH_Instr_is_mulh_instr_a1;

         // For $is_mulhsu_instr.
         always_ff @(posedge clkP_FETCH_Instr_valid_decode_a2) FETCH_Instr_is_mulhsu_instr_a2 <= FETCH_Instr_is_mulhsu_instr_a1;

         // For $is_mulhu_instr.
         always_ff @(posedge clkP_FETCH_Instr_valid_decode_a2) FETCH_Instr_is_mulhu_instr_a2 <= FETCH_Instr_is_mulhu_instr_a1;
         ...
         // For $is_rem_instr.
         always_ff @(posedge clkP_FETCH_Instr_valid_decode_a2) FETCH_Instr_is_rem_instr_a2 <= FETCH_Instr_is_rem_instr_a1;

         // For $is_remu_instr.
         always_ff @(posedge clkP_FETCH_Instr_valid_decode_a2) FETCH_Instr_is_remu_instr_a2 <= FETCH_Instr_is_remu_instr_a1;
         ...
         // For $mul_in1.
         always_ff @(posedge clkP_FETCH_Instr_valid_exe_a3) FETCH_Instr_mul_in1_a3[31:0] <= FETCH_Instr_mul_in1_a2[31:0];

         // For $mul_in2.
         always_ff @(posedge clkP_FETCH_Instr_valid_exe_a3) FETCH_Instr_mul_in2_a3[31:0] <= FETCH_Instr_mul_in2_a2[31:0];

         // For $mul_stall.
         always_ff @(posedge clk) FETCH_Instr_mul_stall_a3 <= FETCH_Instr_mul_stall_a2;

         // For $multype_instr.
         always_ff @(posedge clkP_FETCH_Instr_valid_decode_a2) FETCH_Instr_multype_instr_a2 <= FETCH_Instr_multype_instr_a1;
         ...
         // For $second_issue_div_mul.
         always_ff @(posedge clk) FETCH_Instr_second_issue_div_mul_a1 <= FETCH_Instr_second_issue_div_mul_a0;
         always_ff @(posedge clk) FETCH_Instr_second_issue_div_mul_a2 <= FETCH_Instr_second_issue_div_mul_a1;
         ...
         // For $stall_cnt.
         always_ff @(posedge clk) FETCH_Instr_stall_cnt_a3[5:0] <= FETCH_Instr_stall_cnt_a2[5:0];

         // For $stall_cnt_upper_div.
         always_ff @(posedge clk) FETCH_Instr_stall_cnt_upper_div_a3 <= FETCH_Instr_stall_cnt_upper_div_a2;
         always_ff @(posedge clk) FETCH_Instr_stall_cnt_upper_div_a4 <= FETCH_Instr_stall_cnt_upper_div_a3;
         always_ff @(posedge clk) FETCH_Instr_stall_cnt_upper_div_a5 <= FETCH_Instr_stall_cnt_upper_div_a4;

         // For $stall_cnt_upper_mul.
         always_ff @(posedge clk) FETCH_Instr_stall_cnt_upper_mul_a3 <= FETCH_Instr_stall_cnt_upper_mul_a2;
         always_ff @(posedge clk) FETCH_Instr_stall_cnt_upper_mul_a4 <= FETCH_Instr_stall_cnt_upper_mul_a3;
         always_ff @(posedge clk) FETCH_Instr_stall_cnt_upper_mul_a5 <= FETCH_Instr_stall_cnt_upper_mul_a4;
         ...
         //
            ...
            always_ff @(posedge clk) FETCH_Instr_HoldInst_dest_reg_a4[4:0] <= FETCH_Instr_HoldInst_dest_reg_a3[4:0];
