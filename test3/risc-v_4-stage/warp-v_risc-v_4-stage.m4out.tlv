...
\source warp-v_risc-v_4-stage.tlv 5
\SV
   // Include WARP-V.
...
\source warp-v_risc-v_4-stage.tlv 9
\TLV
   \source ./warpv.tlv 3556   // Instantiated from warp-v_risc-v_4-stage.tlv, 11 as: m4+warpv()
      // =================
      //
      //    THE MODEL
      //
      ...
      \source ./warpv.tlv 2814   // Instantiated from warp-v_risc-v_4-stage.tlv, 3564 as: m4+cpu(/top)
         ...
         \source <builtin> 1   // Instantiated from warp-v_risc-v_4-stage.tlv, 2819 as: m4+indirect(M4_IMEM_MACRO_NAME, M4_PROG_NAME)
            \source ./warpv.tlv 1289   // Instantiated from built-in definition.
               \source <builtin> 1   // Instantiated from warp-v_risc-v_4-stage.tlv, 1290 as: m4+indirect(['riscv_']divmul_test['_prog'])
            ...
            /instr
               ...
               \source <builtin> 1   // Instantiated from warp-v_risc-v_4-stage.tlv, 3099 as: m4+indirect(M4_isa['_exe'], @M4_EXECUTE_STAGE, @M4_RESULT_STAGE)
                  \source ./warpv.tlv 1641   // Instantiated from built-in definition.
                     ...
                     \source ./warpv.tlv 2570   // Instantiated from warp-v_risc-v_4-stage.tlv, 11 as: m4+m_extension()
                     ...
                     @2
                        ...
                        \source ./warpv.tlv 2607   // Instantiated from warp-v_risc-v_4-stage.tlv, 11 as: m4+warpv_mul(|fetch/instr,/mul1, $mulblock_rslt, $wrm, $waitm, $readym, $clk, $resetn, $mul_in1, $mul_in2, $instr_type_mul, $mulblk_valid)
                           /mul1      
                        ...
                        \end_source
                        \source ./warpv.tlv 2637   // Instantiated from warp-v_risc-v_4-stage.tlv, 11 as: m4+warpv_div(|fetch/instr,/div1, $divblock_rslt, $wrd, $waitd, $readyd, $clk, $resetn, $div_in1, $div_in2, $instr_type_div, >>1$div_stall)
                           /div1
                     ...
                     \source ./warpv.tlv 1394   // Instantiated from warp-v_risc-v_4-stage.tlv, 1894 as: m4+riscv_csrs((m4_csrs))
                        ...
                        \source ./warpv.tlv 1352   // Instantiated from warp-v_risc-v_4-stage.tlv, 11 as: m4+riscv_csr(m4_echo(['m4_csr_']csr['_args']))
                           //--------------
                           // CSR CYCLE
                           //--------------
                           @1
   ...
   \end_source
   \source ./warpv.tlv 3196   // Instantiated from warp-v_risc-v_4-stage.tlv, 12 as: m4+warpv_makerchip_cnt10_tb()
      |fetch
         /instr
            @3
   ...
   \end_source
   \source ./warpv.tlv 4013   // Instantiated from warp-v_risc-v_4-stage.tlv, 13 as: m4+makerchip_pass_fail()
      |done
         @0
            // Assert these to end simulation (before Makerchip cycle limit).
