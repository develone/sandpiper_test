...
// For |bank$NumTransactions.
logic [15:0] BANK_NumTransactions_a1,
...
generate
   ...
   //
      ...
      // For $NumTransactions.
      always_ff @(posedge clkF_BANK_valid_transaction_or_reset_a3) BANK_NumTransactions_a2[15:0] <= BANK_NumTransactions_a1[15:0];
