...
void Vfibon::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vfibon::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vfibon__Syms* __restrict vlSymsp = static_cast<Vfibon__Syms*>(userp);
    Vfibon* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgWData(oldp+21,(__Vtemp36),257);
            tracep->chgBit(oldp+30,(vlTOPp->top__DOT__pseudo_rand__DOT__DEFAULT_reset_a1));
        }
        tracep->chgBit(oldp+31,(vlTOPp->clk));
        tracep->chgBit(oldp+32,(vlTOPp->reset));
        tracep->chgIData(oldp+33,(vlTOPp->cyc_cnt),32);
        tracep->chgBit(oldp+34,(vlTOPp->passed));
...
void Vfibon::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vfibon__Syms* __restrict vlSymsp = static_cast<Vfibon__Syms*>(userp);
    Vfibon* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
