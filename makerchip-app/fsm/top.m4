   ...
   |ctrl
      @0
         ...
         /floor[*]
            ...
            $called_above = $UpLight   || ((#floor == 2) ? 1'b0 : /floor[((#floor + 1) % 3)]$called || /floor[((#floor + 1) % 3)]$called_above);
            $called_below = $DownLight || ((#floor == 0) ? 1'b0 : /floor[((#floor + 2) % 3)]$called || /floor[((#floor + 2) % 3)]$called_below);
