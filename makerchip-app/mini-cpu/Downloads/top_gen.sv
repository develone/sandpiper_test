   ...
   if (1) begin : DEBUG_SIGS
      ...
      if (1) begin : \|fetch 
         ...
         if (1) begin : \/instr 
            ...
            logic [11:0] \>>?$ld@0$addr ;
            assign \>>?$ld@0$addr = FETCH_Instr_addr_a0;
            logic  \>>@0$branch ;
            assign \>>@0$branch = FETCH_Instr_branch_a0;
            logic [11:0] \>>?$branch@0$branch_target ;
            assign \>>?$branch@0$branch_target = FETCH_Instr_branch_target_a0;
            logic  \>>?$op_compare@0$compare_rslt ;
            assign \>>?$op_compare@0$compare_rslt = FETCH_Instr_compare_rslt_a0;
            ...
            logic [11:0] \>>?$jump@0$jump_target ;
            assign \>>?$jump@0$jump_target = FETCH_Instr_jump_target_a0;
            logic  \>>@0$ld ;
            assign \>>@0$ld = FETCH_Instr_ld_a0;
            logic [11:0] \>>?$ld@0$ld_rslt ;
            assign \>>?$ld@0$ld_rslt = FETCH_Instr_ld_rslt_a0;
            logic  \>>@0$no_dest ;
            ...
            logic [11:0] \>>?$op_full@0$op_full_rslt ;
            assign \>>?$op_full@0$op_full_rslt = FETCH_Instr_op_full_rslt_a0;
            logic [39:0] \>>@0$raw ;
            assign \>>@0$raw = FETCH_Instr_raw_a0;
            logic  \>>@0$reset ;
            assign \>>@0$reset = FETCH_Instr_reset_a0;
            logic [11:0] \>>?$dest_valid@0$rslt ;
            assign \>>?$dest_valid@0$rslt = FETCH_Instr_rslt_a0;
            logic  \>>@0$st ;
            ...
            for (src = 1; src <= 2; src++) begin : \/src 
               ...
               logic [11:0] \>>>?$local_is_reg@0$reg_value ;
               assign \>>>?$local_is_reg@0$reg_value = L1c_FETCH_Instr_Src[src].L1_reg_value_a0;
               logic  \>>>@0$valid ;
               assign \>>>@0$valid = L1c_FETCH_Instr_Src[src].L1_valid_a0;
               logic [11:0] \>>>?$valid@0$value ;
               assign \>>>?$valid@0$value = L1c_FETCH_Instr_Src[src].L1_value_a0;
            end
         end
      end
